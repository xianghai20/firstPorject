<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"E:\xhweb\webRoot\thinkphp/app/index\view\index\queryCet.html";i:1544491035;s:57:"E:\xhweb\webRoot\thinkphp\app\index\view\common\head.html";i:1544420563;s:57:"E:\xhweb\webRoot\thinkphp\app\index\view\common\foot.html";i:1544435560;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="main">
    ...
    <div id="backGround" class="satic-area">
    ...
    <div class="boxes">
        <div class="cardBox" id="cardBox">
            ...
            <div class="inputBox">
                <label class="navTitle">姓&nbsp;&nbsp;名：</label>
                <input v-model="name" class="name" id="name" type="text" maxlength="20" placeholder="请输入姓名">

            </div>
            <div class="inputBox">
                <label class="navTitle">准考证号：</label>
                <input v-model="num" type="text" class="number" id="number" maxlength="20" placeholder="请输入准考证">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button id="query" v-on:click="check" class="layui-btn">立即查询</button>
